  ...
  return (
    <main className="relative h-screen w-full bg-background overflow-hidden">
      ...
      <section className={cn(
        ...
        <div className="absolute top-8 left-8 z-[20] animate-in fade-in slide-in-from-top-4 duration-1000 flex items-center gap-4">
          {brandLogo && (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 md:px-8 text-center z-10 pt-20">
          <div className="mb-8 md:mb-12 max-w-4xl transform animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <h1 className="font-headline font-bold text-white tracking-tight leading-tight text-4xl md:text-7xl mb-4 md:mb-6 text-shadow-strong">
              See India <span className="text-white/80">differently.</span>
            </h1>
          ...
          <div className="w-full max-w-2xl px-4 animate-in zoom-in-95 duration-700 delay-300">
            <div className="bg-white/95 backdrop-blur-md rounded-full p-1 flex items-center shadow-2xl border border-white/40">
              ...
              <Input 
                ...
                className="bg-transparent border-0 ring-0 focus-visible:ring-0 text-sm md:text-lg h-12 md:h-14 placeholder:text-primary/30 font-medium"
              />
              <Button 
                onClick={onExplore}
                className="rounded-full bg-accent hover:bg-accent/90 text-white h-12 md:h-14 px-6 md:px-10 font-bold text-[10px] md:text-xs tracking-[0.1em] uppercase gap-2 shadow-lg shrink-0"
              >
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-2 md:gap-3 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
              {SHORTCUTS.map((city) => (
                <button 
                  ...
                  className="px-6 py-2.5 rounded-full bg-white/10 backdrop-blur-md border border-white/30 text-white text-[10px] md:text-[12px] font-bold hover:bg-white/30 transition-all shadow-sm uppercase tracking-widest"
                >
                  {city}
                </button>
              ))}
